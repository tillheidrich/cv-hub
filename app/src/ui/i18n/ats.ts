...
export const ATS_I18N: Record<UiLang, AtsStrings> = {
  de: {
    ...
    issuePhone: 'Telefon fehlt — ATS-Filter werfen Bewerbungen ohne Telefonnummer oft direkt aus.',
  ...
  en: {
    ...
    issuePhone: 'Phone number missing — ATS filters often reject applications without a phone number outright.',
  ...
  fr: {
    ...
    issuePhone: "Téléphone manquant — les filtres ATS écartent souvent d'emblée les candidatures sans numéro de téléphone.",
  ...
  es: {
    ...
    issuePhone: 'Falta el teléfono — los filtros ATS suelen descartar directamente las candidaturas sin número de teléfono.',
